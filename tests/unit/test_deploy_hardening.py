...
class DeployHardeningTest(unittest.TestCase):
    ...
    def test_compose_files_forward_mcp_environment(self):
        expected_entries = (
            ...
            "MCP_MACHINE_MAX_BODY_BYTES=${MCP_MACHINE_MAX_BODY_BYTES:-8388608}",
            "MCP_PUBLISH_RATE_LIMIT_PER_HOUR=${MCP_PUBLISH_RATE_LIMIT_PER_HOUR:-500}",
            "MCP_PUBLISH_RATE_LIMIT_PER_DAY=${MCP_PUBLISH_RATE_LIMIT_PER_DAY:-5000}",
        )
