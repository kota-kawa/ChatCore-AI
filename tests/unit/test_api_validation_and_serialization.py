...
class ApiValidationAndSerializationTestCase(unittest.TestCase):
    ...
    def test_chat_json_response_path_includes_web_search_sources(self):
        ...
        self.assertIn('<span class="web-search-sources__label">参照したWebサイト</span>', payload["response"])
        self.assertIn('<span class="web-search-sources__count">1件</span>', payload["response"])
