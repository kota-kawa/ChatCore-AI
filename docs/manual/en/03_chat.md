...
Enter a message and send it. Choose a model or task when the controls are available. The assistant normally replies in the language of your request; you can explicitly request another language at any time.
