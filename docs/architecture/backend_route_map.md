...
| `chat_bp` | `/`, `/settings`, `/api/*` | `blueprints/chat/{views,rooms,messages,tasks,skills,projects,profile,preferences,avatar_media}.py` | チャット、部屋、SSE、タスク、個人Skill、プロジェクト、プロフィール、設定、アバター画像配信 |
