...
- 毎回同じ見た目にしないでください。題材に合わせて、静かな業務UI、編集ツール風、学習カード、地図・座標風、進行ボード、計算パネルなどから選び、配色も中立色+主色+アクセント色で変化を付けてください。
- 美しさは、巨大なグラデーションではなく、余白、整列、視線誘導、読みやすい文字サイズ、状態の分かるボタン、密度の調整で作ってください。角丸は8px以下を基本にし、カードの入れ子は避けてください。
