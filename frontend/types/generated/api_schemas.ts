...
// Schema fingerprint: 2b952830b10e766795d2562778378d418579f305d52f76392083dece101235e7
...
export const ToolApprovalDecisionRequestSchema = z.object({ "decision": z.enum(["approve_once","approve_always","deny"]) }).strict();
...
export const SharedPromptCreateRequestSchema = z.object({ "title": z.string().min(1).max(255), "category": z.string().default(""), "content": z.string().max(256000).default(""), "description": z.string().max(300).default(""), "content_format": z.string().default("prompt"), "media_type": z.string().default("text"), "input_examples": z.string().max(256000).default(""), "output_examples": z.string().max(256000).default(""), "ai_model": z.string().max(100).default(""), "attributes": z.record(z.string(), z.string()).optional(), "resources": z.array(z.object({ "path": z.string(), "role": z.enum(["script","reference","config","other"]).default("other"), "language": z.string().max(64).default(""), "content": z.string(), "media_type": z.string().max(128).default("") }).strict()).max(50).optional() });
...
export const MemoCreateRequestSchema = z.object({ "ai_response": z.string().default(""), "title": z.string().default(""), "collection_id": z.union([z.number().int(), z.null()]).default(null), "background_color": z.union([z.string().regex(new RegExp("^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$")).max(20), z.null()]).default(null) });
...
export const MemoUpdateRequestSchema = z.object({ "title": z.union([z.string(), z.null()]).default(null), "ai_response": z.union([z.string(), z.null()]).default(null), "collection_id": z.union([z.number().int(), z.null()]).default(null), "clear_collection": z.boolean().default(false), "background_color": z.union([z.string().regex(new RegExp("^#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6})$")).max(20), z.null()]).default(null), "clear_background_color": z.boolean().default(false) });
...
export const ContextFactCandidateRejectRequestSchema = z.object({ "revision": z.number().int().gte(1) });
export type ContextFactCandidateRejectRequest = z.infer<typeof ContextFactCandidateRejectRequestSchema>;
...
export const ToolApprovalApiSchema = z.object({ "id": z.string().min(1), "tool": z.enum(["memo_create","memo_append","memo_edit"]), "family": z.literal("memo"), "status": z.enum(["pending","succeeded","failed","denied","expired","superseded","cancelled"]), "decision": z.union([z.enum(["once","always","auto","deny"]), z.null()]).default(null), "always_allowed": z.boolean().default(false), "preview": z.union([z.object({ "kind": z.literal("memo_create"), "title": z.string().default(""), "content": z.string() }), z.object({ "kind": z.literal("memo_append"), "memo_id": z.number().int().gte(1), "memo_title": z.string().default(""), "text": z.string(), "separator": z.string().default("") }), z.object({ "kind": z.literal("memo_edit"), "memo_id": z.number().int().gte(1), "memo_title": z.string().default(""), "new_title": z.union([z.string(), z.null()]).default(null), "mode": z.enum(["edits","content"]), "edits": z.array(z.object({ "before": z.string(), "after": z.string() })).optional(), "content": z.union([z.string(), z.null()]).default(null), "base_revision": z.number().int().gte(1) }), z.null()]).default(null), "warnings": z.array(z.enum(["shared_memo","untrusted_input_in_turn"])).optional(), "expires_at": z.union([z.string(), z.null()]).default(null), "result": z.union([z.object({ "target_id": z.union([z.number().int(), z.null()]).default(null), "target_title": z.union([z.string(), z.null()]).default(null), "error_code": z.union([z.string(), z.null()]).default(null) }), z.null()]).default(null), "readonly": z.boolean().default(false) });
export type ToolApprovalApi = z.infer<typeof ToolApprovalApiSchema>;

export const ToolApprovalDecisionResponseSchema = z.object({ "approval": z.object({ "id": z.string().min(1), "tool": z.enum(["memo_create","memo_append","memo_edit"]), "family": z.literal("memo"), "status": z.enum(["pending","succeeded","failed","denied","expired","superseded","cancelled"]), "decision": z.union([z.enum(["once","always","auto","deny"]), z.null()]).default(null), "always_allowed": z.boolean().default(false), "preview": z.union([z.object({ "kind": z.literal("memo_create"), "title": z.string().default(""), "content": z.string() }), z.object({ "kind": z.literal("memo_append"), "memo_id": z.number().int().gte(1), "memo_title": z.string().default(""), "text": z.string(), "separator": z.string().default("") }), z.object({ "kind": z.literal("memo_edit"), "memo_id": z.number().int().gte(1), "memo_title": z.string().default(""), "new_title": z.union([z.string(), z.null()]).default(null), "mode": z.enum(["edits","content"]), "edits": z.array(z.object({ "before": z.string(), "after": z.string() })).optional(), "content": z.union([z.string(), z.null()]).default(null), "base_revision": z.number().int().gte(1) }), z.null()]).default(null), "warnings": z.array(z.enum(["shared_memo","untrusted_input_in_turn"])).optional(), "expires_at": z.union([z.string(), z.null()]).default(null), "result": z.union([z.object({ "target_id": z.union([z.number().int(), z.null()]).default(null), "target_title": z.union([z.string(), z.null()]).default(null), "error_code": z.union([z.string(), z.null()]).default(null) }), z.null()]).default(null), "readonly": z.boolean().default(false) }) }).catchall(z.any());
export type ToolApprovalDecisionResponse = z.infer<typeof ToolApprovalDecisionResponseSchema>;

export const ToolApprovalConflictResponseSchema = z.object({ "error": z.union([z.string(), z.null()]).default(null), "message": z.union([z.string(), z.null()]).default(null), "detail": z.union([z.string(), z.array(z.union([z.string(), z.object({ "msg": z.union([z.string(), z.null()]).default(null) }).catchall(z.any())])), z.null()]).default(null), "code": z.union([z.string(), z.null()]).default(null), "params": z.union([z.record(z.string(), z.any()), z.null()]).default(null), "approval": z.union([z.object({ "id": z.string().min(1), "tool": z.enum(["memo_create","memo_append","memo_edit"]), "family": z.literal("memo"), "status": z.enum(["pending","succeeded","failed","denied","expired","superseded","cancelled"]), "decision": z.union([z.enum(["once","always","auto","deny"]), z.null()]).default(null), "always_allowed": z.boolean().default(false), "preview": z.union([z.object({ "kind": z.literal("memo_create"), "title": z.string().default(""), "content": z.string() }), z.object({ "kind": z.literal("memo_append"), "memo_id": z.number().int().gte(1), "memo_title": z.string().default(""), "text": z.string(), "separator": z.string().default("") }), z.object({ "kind": z.literal("memo_edit"), "memo_id": z.number().int().gte(1), "memo_title": z.string().default(""), "new_title": z.union([z.string(), z.null()]).default(null), "mode": z.enum(["edits","content"]), "edits": z.array(z.object({ "before": z.string(), "after": z.string() })).optional(), "content": z.union([z.string(), z.null()]).default(null), "base_revision": z.number().int().gte(1) }), z.null()]).default(null), "warnings": z.array(z.enum(["shared_memo","untrusted_input_in_turn"])).optional(), "expires_at": z.union([z.string(), z.null()]).default(null), "result": z.union([z.object({ "target_id": z.union([z.number().int(), z.null()]).default(null), "target_title": z.union([z.string(), z.null()]).default(null), "error_code": z.union([z.string(), z.null()]).default(null) }), z.null()]).default(null), "readonly": z.boolean().default(false) }), z.null()]).default(null) }).catchall(z.any());
export type ToolApprovalConflictResponse = z.infer<typeof ToolApprovalConflictResponseSchema>;

export const ToolAutoApprovalApiSchema = z.object({ "tool_name": z.enum(["memo_create","memo_append","memo_edit"]), "family": z.literal("memo"), "created_at": z.string() }).catchall(z.any());
export type ToolAutoApprovalApi = z.infer<typeof ToolAutoApprovalApiSchema>;

export const ToolAutoApprovalsResponseSchema = z.object({ "grants": z.array(z.object({ "tool_name": z.enum(["memo_create","memo_append","memo_edit"]), "family": z.literal("memo"), "created_at": z.string() }).catchall(z.any())).optional() }).catchall(z.any());
export type ToolAutoApprovalsResponse = z.infer<typeof ToolAutoApprovalsResponseSchema>;

export const ToolAutoApprovalRevokeResponseSchema = z.object({ "revoked": z.boolean() }).catchall(z.any());
export type ToolAutoApprovalRevokeResponse = z.infer<typeof ToolAutoApprovalRevokeResponseSchema>;
...
export const LikedPromptApiSchema = z.object({ "id": z.union([z.number().int(), z.string(), z.null()]).default(null), "title": z.string(), "content": z.string(), "description": z.union([z.string(), z.null()]).default(""), "category": z.union([z.string(), z.null()]).default(""), "input_examples": z.union([z.string(), z.null()]).default(""), "output_examples": z.union([z.string(), z.null()]).default(""), "created_at": z.union([z.string(), z.null()]).default(null), "content_format": z.union([z.string(), z.null()]).default("prompt"), "media_type": z.union([z.string(), z.null()]).default("text"), "attributes": z.record(z.string(), z.string()).optional(), "attachments": z.array(z.record(z.string(), z.string())).optional(), "reference_image_url": z.union([z.string(), z.null()]).default(null), "skill_markdown": z.union([z.string(), z.null()]).default(""), "like_id": z.union([z.number().int(), z.string(), z.null()]).default(null), "prompt_id": z.union([z.number().int(), z.string(), z.null()]).default(null), "author": z.union([z.string(), z.null()]).default(null), "prompt_type": z.union([z.string(), z.null()]).default("text"), "skill_python_script": z.union([z.string(), z.null()]).default(""), "resources": z.array(z.object({ "id": z.union([z.number().int(), z.null()]).default(null), "path": z.string(), "role": z.enum(["script","reference","config","other"]).default("other"), "language": z.string().default("text"), "media_type": z.string().default("text/plain"), "content": z.string().default(""), "size_bytes": z.number().int().default(0), "sha256": z.string().default(""), "sort_order": z.number().int().default(0), "created_at": z.union([z.string(), z.null()]).default(null), "updated_at": z.union([z.string(), z.null()]).default(null) }).catchall(z.any())).optional(), "prompt_created_at": z.union([z.string(), z.null()]).default(null), "liked_at": z.union([z.string(), z.null()]).default(null), "liked": z.boolean().default(true) }).catchall(z.any());
export type LikedPromptApi = z.infer<typeof LikedPromptApiSchema>;

export const MyPromptsApiResponseSchema = z.object({ "prompts": z.array(z.object({ "id": z.union([z.number().int(), z.string(), z.null()]).default(null), "title": z.string(), "content": z.string(), "description": z.union([z.string(), z.null()]).default(""), "category": z.union([z.string(), z.null()]).default(""), "input_examples": z.union([z.string(), z.null()]).default(""), "output_examples": z.union([z.string(), z.null()]).default(""), "created_at": z.union([z.string(), z.null()]).default(null), "content_format": z.union([z.string(), z.null()]).default("prompt"), "media_type": z.union([z.string(), z.null()]).default("text"), "attributes": z.record(z.string(), z.string()).optional(), "attachments": z.array(z.record(z.string(), z.string())).optional(), "reference_image_url": z.union([z.string(), z.null()]).default(null), "skill_markdown": z.union([z.string(), z.null()]).default("") }).catchall(z.any())).optional() }).catchall(z.any());
export type MyPromptsApiResponse = z.infer<typeof MyPromptsApiResponseSchema>;

export const LikedPromptsApiResponseSchema = z.object({ "prompts": z.array(z.object({ "id": z.union([z.number().int(), z.string(), z.null()]).default(null), "title": z.string(), "content": z.string(), "description": z.union([z.string(), z.null()]).default(""), "category": z.union([z.string(), z.null()]).default(""), "input_examples": z.union([z.string(), z.null()]).default(""), "output_examples": z.union([z.string(), z.null()]).default(""), "created_at": z.union([z.string(), z.null()]).default(null), "content_format": z.union([z.string(), z.null()]).default("prompt"), "media_type": z.union([z.string(), z.null()]).default("text"), "attributes": z.record(z.string(), z.string()).optional(), "attachments": z.array(z.record(z.string(), z.string())).optional(), "reference_image_url": z.union([z.string(), z.null()]).default(null), "skill_markdown": z.union([z.string(), z.null()]).default(""), "like_id": z.union([z.number().int(), z.string(), z.null()]).default(null), "prompt_id": z.union([z.number().int(), z.string(), z.null()]).default(null), "author": z.union([z.string(), z.null()]).default(null), "prompt_type": z.union([z.string(), z.null()]).default("text"), "skill_python_script": z.union([z.string(), z.null()]).default(""), "resources": z.array(z.object({ "id": z.union([z.number().int(), z.null()]).default(null), "path": z.string(), "role": z.enum(["script","reference","config","other"]).default("other"), "language": z.string().default("text"), "media_type": z.string().default("text/plain"), "content": z.string().default(""), "size_bytes": z.number().int().default(0), "sha256": z.string().default(""), "sort_order": z.number().int().default(0), "created_at": z.union([z.string(), z.null()]).default(null), "updated_at": z.union([z.string(), z.null()]).default(null) }).catchall(z.any())).optional(), "prompt_created_at": z.union([z.string(), z.null()]).default(null), "liked_at": z.union([z.string(), z.null()]).default(null), "liked": z.boolean().default(true) }).catchall(z.any())).optional() }).catchall(z.any());
...
export const ContextFactCandidateListResponseSchema = z.object({ "candidates": z.array(z.object({ "id": z.number().int(), "fact_type": z.enum(["preference","profile","project","decision","reference"]), "title": z.string(), "content": z.string(), "source_kind": z.enum(["manual","chat","mcp","import"]).default("chat"), "source_ref": z.union([z.string(), z.null()]).default(null), "importance": z.number().int().gte(0).lte(100).default(50), "confidence": z.number().gte(0).lte(1).default(0), "status": z.enum(["pending","approved","rejected"]), "revision": z.number().int().gte(1), "created_at": z.union([z.string(), z.null()]).default(null), "updated_at": z.union([z.string(), z.null()]).default(null) }).catchall(z.any())).optional(), "next_cursor": z.union([z.string(), z.null()]).default(null), "total_pending": z.number().int().default(0) }).catchall(z.any());
export type ContextFactCandidateListResponse = z.infer<typeof ContextFactCandidateListResponseSchema>;

export const ContextFactCandidateApprovalResponseSchema = z.object({ "candidate": z.object({ "id": z.number().int(), "fact_type": z.enum(["preference","profile","project","decision","reference"]), "title": z.string(), "content": z.string(), "source_kind": z.enum(["manual","chat","mcp","import"]).default("chat"), "source_ref": z.union([z.string(), z.null()]).default(null), "importance": z.number().int().gte(0).lte(100).default(50), "confidence": z.number().gte(0).lte(1).default(0), "status": z.enum(["pending","approved","rejected"]), "revision": z.number().int().gte(1), "created_at": z.union([z.string(), z.null()]).default(null), "updated_at": z.union([z.string(), z.null()]).default(null) }).catchall(z.any()), "fact": z.object({ "id": z.number().int(), "fact_type": z.enum(["preference","profile","project","decision","reference"]), "title": z.string(), "content": z.string(), "status": z.enum(["active","deprecated"]), "revision": z.number().int(), "source_kind": z.enum(["manual","chat","mcp","import"]).default("manual"), "importance": z.number().int().gte(0).lte(100).default(50), "created_at": z.union([z.string(), z.null()]).default(null), "updated_at": z.union([z.string(), z.null()]).default(null) }).catchall(z.any()) }).catchall(z.any());
export type ContextFactCandidateApprovalResponse = z.infer<typeof ContextFactCandidateApprovalResponseSchema>;

export const ContextExtractionSettingsResponseSchema = z.object({ "enabled": z.boolean().default(false) }).catchall(z.any());
export type ContextExtractionSettingsResponse = z.infer<typeof ContextExtractionSettingsResponseSchema>;
