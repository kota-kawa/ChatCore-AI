...
RESEARCH_LOOP_SYSTEM_PROMPT = (
    ...
    f"{STEP_NOTE_OPEN_TAG}one or two short sentences summarizing the latest evidence, any "
    f"unresolved requirement, and why this next tool call follows from it{STEP_NOTE_CLOSE_TAG}. "
    "The note is an incremental semantic checkpoint: keep concrete facts tied to the evidence "
    "already in context, never invent details, and keep it short. The note is internal, is "
