...
_MESSAGES: dict[Locale, dict[str, str]] = {
    "ja": {
        ...
        "ai_agent.progress.memo_edit": "編集案を作成中...",
        "ai_agent.progress.response": "回答を生成中...",
        "ai_agent.progress.request": "依頼内容を確認中...",
        "ai_agent.progress.page_analysis": "ページを解析中...",
        "ai_agent.progress.action_plan": "操作手順を生成中...",
        "ai_agent.progress.current_page": "現在のページを確認中...",
        "ai_agent.progress.manual": "マニュアルを検索中...",
        "ai_agent.progress.code": "コードを探索中...",
        "ai_agent.error.busy": "AIエージェントの呼び出しが混み合っています。時間をおいて再試行してください。",
        "ai_agent.error.configuration": "AIエージェントの設定エラーが発生しました。管理者に連絡してください。",
        ...
        "usage_limit.monthly_budget": (
            "今月のサービス全体の利用枠に達したため、AI機能を一時停止しています。"
            "翌月1日の0時（日本時間）に再開します。"
        ),
    },
    "en": {
        ...
        "ai_agent.progress.request": "Checking your request...",
        "ai_agent.progress.page_analysis": "Analyzing the page...",
        "ai_agent.progress.action_plan": "Preparing the action steps...",
        "ai_agent.progress.current_page": "Checking the current page...",
        "ai_agent.progress.manual": "Searching the manual...",
        "ai_agent.progress.code": "Searching the codebase...",
        "ai_agent.error.busy": "The AI agent is busy. Wait a moment and try again.",
        "ai_agent.error.configuration": "The AI agent is not configured correctly. Contact an administrator.",
        ...
        "usage_limit.monthly_budget": (
            "AI features are paused because the service has used its budget for this month. "
            "They resume at midnight on the 1st, Japan time."
        ),
    },
}
