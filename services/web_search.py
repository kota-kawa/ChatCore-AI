...
def build_prior_web_search_system_message(
    ...
    *,
    ...
    header = [
        ...
        "Also use this earlier search context when the user refers to it implicitly through a short follow-up, objection, comparison, correction, or omitted subject, even if they do not explicitly say \"the earlier result\" or \"the article\".",
