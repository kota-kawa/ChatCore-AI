...
PAGES: tuple[AgentPage, ...] = (
    ...
    AgentPage(
        ...
        route="/prompt_share",
        summary="公開プロンプトを検索、カテゴリ絞り込み、詳細表示、いいね、チャットで使う、共有、投稿できる画面。",
        features=(
            "キーワードで公開プロンプトを検索できる。",
            "カテゴリで絞り込める。",
            "プロンプト詳細を開いて本文や例を確認できる。",
            "ログイン中はプロンプトを投稿、いいね、チャットで使うための追加ができる。",
            "共有リンクを作成してコピーできる。",
        ),
        actions=(
    ...
    AgentPage(
        ...
        route="/settings",
        summary="プロフィール、外観テーマ、投稿したプロンプト、いいねしたプロンプト、通知、セキュリティ/Passkeyを管理する画面。",
        features=(
            "プロフィール、メール、自己紹介、AI向けプロフィール文脈を編集できる。",
            "ライト/ダーク/システム連動テーマを切り替えられる。",
            "投稿したプロンプトといいねしたプロンプトを管理できる。",
        ...
        actions=(
            ...
            AgentAction("いいねしたプロンプト", "click", "[data-section='liked-prompts']", "いいねしたプロンプトタブを開く。"),
