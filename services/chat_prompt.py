    ...
    *,
    ...
    runtime_context = "\n".join(
        [
            ...
            "whenever current information is needed. The search-and-review loop runs on a bounded",
            "budget of tool calls and reasoning turns; when the tools stop being offered, answer",
